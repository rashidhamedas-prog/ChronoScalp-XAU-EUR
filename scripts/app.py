...
UI = {
    "fa": {
        ...
        "symbols_hint": "نماد را انتخاب کنید. طلا و یورو: دلتا + استرادل خبر.",
        "symbols_save": "اعمال نمادها",
        "strategies_label": "استراتژی هر نماد",
        "strategies_hint": "طلا و یورو: دلتا + استرادل خبر. انتخاب جداگانه وجود ندارد.",
    ...
    "en": {
        ...
        "symbols_hint": "Select symbols. Gold and EUR each run Delta + news straddle.",
        "symbols_save": "Apply symbols",
        "strategies_label": "Strategies per symbol",
        "strategies_hint": "Gold and EUR: Delta + news straddle. No separate picker.",
