...
UI = {
    "fa": {
        ...
        "symbols_hint": "نماد را انتخاب کنید. طلا: دلتا + استرادل خبر. یورو: استرادل خبر.",
        "symbols_save": "اعمال نمادها",
        "strategies_label": "استراتژی هر نماد",
        "strategies_hint": "طلا: دلتا + استرادل خبر. یورو: دلتا (فید/پولبک) + استرادل خبر. انتخاب جداگانه وجود ندارد.",
    ...
    "en": {
        ...
        "symbols_hint": "Select symbols. Gold: Delta + news straddle. EUR: fade/pullback Delta + news straddle.",
        "symbols_save": "Apply symbols",
        "strategies_label": "Strategies per symbol",
        "strategies_hint": "Gold: Delta + news straddle. EUR: fade/pullback Delta + news straddle. No separate picker.",
