...
UI = {
    "fa": {
        ...
        "strategies_hint": "طلا: دلتا + استرادل خبر. یورو: فقط استرادل خبر. انتخاب جداگانه وجود ندارد.",
    ...
    "en": {
        ...
        "symbols_hint": "Select symbols. Gold: Delta + news straddle. EUR: news straddle only.",
        "symbols_save": "Apply symbols",
        "strategies_label": "Strategies per symbol",
        "strategies_hint": "Gold: Delta + news straddle. EUR: news straddle only. No separate picker.",
