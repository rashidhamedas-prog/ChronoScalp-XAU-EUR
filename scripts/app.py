...
UI = {
    "fa": {
        ...
        "symbols_hint": "نماد را انتخاب کنید. طلا: دلتا + سبک اپراتور + استرادل خبر. یورو: سبک اپراتور + استرادل خبر.",
        "symbols_save": "اعمال نمادها",
        "strategies_label": "استراتژی هر نماد",
        "strategies_hint": "طلا: دلتا + سبک اپراتور + استرادل خبر. یورو: سبک اپراتور + استرادل خبر. انتخاب جداگانه وجود ندارد.",
        "strategies_save": "اعمال استراتژی‌ها",
        "strategy_delta": "دلتا",
        "strategy_operator": "سبک اپراتور",
        "strategy_smc": "SMC",
        "strategy_liq": "نقدینگی + حجم",
        "strategy_scalp": "اسکلپ M1",
        "strategy_news": "استرادل خبر",
    ...
    "en": {
        ...
        "symbols_hint": "Select symbols. Gold: Delta + operator style + news straddle. EUR: operator style + news straddle.",
        "symbols_save": "Apply symbols",
        "strategies_label": "Strategies per symbol",
        "strategies_hint": "Gold: Delta + operator style + news straddle. EUR: operator style + news straddle. No separate picker.",
        "strategies_save": "Apply strategies",
        "strategy_delta": "Delta",
        "strategy_operator": "Operator style",
        "strategy_smc": "SMC",
        "strategy_liq": "Liquidity + Volume",
        "strategy_scalp": "M1 scalp",
        "strategy_news": "News straddle",
...
def page_control(settings) -> None:
    ...
    strategy_labels = {
        ...
        "operator_style": _t("strategy_operator"),
