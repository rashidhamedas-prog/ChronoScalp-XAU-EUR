...
class TelegramControlBot:
    ...
    def _send_symbols_menu(self, chat_id: int, *, note: str = "") -> None:
        ...
        msg = (
            ...
            "طلا: دلتا + سبک اپراتور + استرادل خبر · یورو: سبک اپراتور + استرادل خبر\n"
    ...
    def _cmd_strategies_catalog(self, chat_id: int, _text: str = "") -> None:
        ...
        self.send(
            chat_id,
            "هر نماد کاتالوگ خودش را دارد (طلا: دلتا + سبک اپراتور + استرادل خبر · یورو: سبک اپراتور + استرادل خبر).\n\n"
