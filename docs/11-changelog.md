...
- سبک معاملات دستی اپراتور (magic=0، ۱۴ روز تا ۳ سپتامبر): ADX دوره ۱۵
  و Stochastic دوره ۵. طلا فید اسپایک یا پولبک HTF؛ یورو فقط همان دو
  ستاپ (مسیر سوئیپ شکست‌خورده خاموش). هندسه طلا ۱٫۵R (کف، نه زیر آن).
  حجم ۶–۲۵ لات و گرید کپی نشد.
