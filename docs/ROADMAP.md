...
- [x] **Telegram live positions:** «پوزیشن‌ها» reads MT5/OANDA (or fresh `broker_positions_*.json` snapshot), not journal-only; journal ghost-drop has 90s grace; reconcile records external SL/TP closes with PnL
