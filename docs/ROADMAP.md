...
- [x] **Persian HTML account report:** `scripts/generate_account_report_fa.py` + `reporting/account_report_fa.py` — strategy/symbol/session breakdown from `trade_journal_live.json` (sample: `docs/reports/report_55625500_fa.html` for login 55625500)
