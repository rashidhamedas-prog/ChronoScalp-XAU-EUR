...
- [x] **Live account performance HTML report (login 55625500 / AUSCommercial-Demo):** `docs/گزارش_عملکرد_55625500.html` — strategy/symbol/session breakdown + remediation list
