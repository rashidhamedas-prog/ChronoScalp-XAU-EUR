...
- [ ] EURUSD Delta redesign — 4 trades / −1.00R is an absence of edge, not a tuning problem. Investigate whether the entry filters adversely select the survivors before touching parameters.
