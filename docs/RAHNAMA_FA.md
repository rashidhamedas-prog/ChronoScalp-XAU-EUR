...
> **وضعیت پروژه:** کد و ابزارها آماده‌اند. **تنها مرحله‌ای که باید خودتان انجام دهید** = خرید VPS، ساخت حساب OANDA، و deploy طبق بخش ۸ این راهنما.
...
10. [استارت و استاپ با یک کلیک](#۱۰-استارت-و-استاپ-با-یک-کلیک)
